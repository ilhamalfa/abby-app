...
@section('main')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Car Audio</h1>
    </div>
                ...
                <div class="modal fade" id="modalEditBanner" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ url('/dashboard/audio/editBanner/' . $banner->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                ...
                <div class="modal fade" id="modalEditService1" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ url('/dashboard/audio/editService/' . $service1->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label>Image</label>
                ...
                <div class="modal fade" id="modalEditService2" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ url('/dashboard/audio/editService/' . $service2->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label>Image</label>
                ...
                <div class="modal fade" id="modalAddHighlight" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ url('/dashboard/audio/addHighlight') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label>Image</label>
                                ...
                                <td>
                                    <div class="dropdown no-arrow">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                            ...
                                            <a class="dropdown-item" href="{{ url('/dashboard/audio/deleteHighlight/' . $highlight->id) }}" onclick="return confirm('Delete this?')">Delete</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal fade" id="modalEditHighlight{{ $highlight->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ url('/dashboard/audio/editHighlight/' . $highlight->id) }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label>Image</label>
                ...
                <div class="modal fade" id="modalAddBrand" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ url('/dashboard/audio/addBrand') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label>Image</label>
                                ...
                                <td>
                                    <div class="dropdown no-arrow">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                            ...
                                            <a class="dropdown-item" href="{{ url('/dashboard/audio/deleteBrand/' . $brand->id) }}" onclick="return confirm('Delete this?')">Delete</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal fade" id="modalEditBrand{{ $brand->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ url('/dashboard/audio/editBrand/' . $brand->id) }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label>Image</label>
